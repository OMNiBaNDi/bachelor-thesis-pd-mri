...
INPUT_ROOT=$THESIS/data/SUS_healthy_conversion/SUS_healthy_3Y_DICOM
OUTPUT_ROOT=$THESIS/data/SUS_healthy_conversion/SUS_healthy_3Y_converted_to_nifti
...
echo "SUS healthy 3Y batch conversion"
