#!/usr/bin/env python3
"""Copy selected Bergen healthy-control BL/3Y/5Y NIfTIs (and JSON) into data/Bergen_healthy/BKxx/{BL,3Y,5Y}."""
...
DEFAULT_DEST = Path("/nfs/br1_prosjekt/ParkWest/user/2026vae/AmundEspen/pd_thesis/data/Bergen_healthy")
