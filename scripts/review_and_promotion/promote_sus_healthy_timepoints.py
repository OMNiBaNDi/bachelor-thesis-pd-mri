#!/usr/bin/env python3
"""Copy SUS healthy selections into data/SUS_healthy/SKxx/{3Y,5Y}."""
...
DEFAULT_DEST = Path("/nfs/br1_prosjekt/ParkWest/user/2026vae/AmundEspen/pd_thesis/data/SUS_healthy")
TIMEPOINT_DIRS = {"3Y": "3Y", "5Y": "5Y"}
...
def main() -> int:
    ...
    parser.add_argument("--timepoint", choices=["3Y", "5Y"], help="Limit to one timepoint")
